...
/// The "your order is in" screen, shown once **Place order** has filed a
/// prescription order.
///
...
/// (now empty) basket, not on a form for an order already placed. From here a
/// member either tracks the order or returns to the shop.
class PrescriptionOrderPlacedScreen extends StatelessWidget {
  final Purchase order;

  const PrescriptionOrderPlacedScreen({super.key, required this.order});
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'The pharmacist reads your prescription, prices it, and '
                'messages you before anything is charged.',
