...
class _PayBillSheetState extends State<_PayBillSheet> {
  ...
  Future<void> _payWithWallet() async {
    ...
    // the member actually sees; this is what keeps the server in step.
    unawaited(
      OrderRepository.instance.markOrderPaidByWallet(
